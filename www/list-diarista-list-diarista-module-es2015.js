...
let ListDiaristaPageModule = class ListDiaristaPageModule {
};
...
let ListDiaristaPage = class ListDiaristaPage {
    constructor(DiaristaService, http) {
    ...
    mostraTudoDiarista() {
        this.DiaristaService.getDiarista().subscribe(data => {
            const response = data;
...
ListDiaristaPage.ctorParameters = () => [
...
//# sourceMappingURL=list-diarista-list-diarista-module-es2015.js.map