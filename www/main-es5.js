...
var map = {
	"./cad-cliente/cad-cliente.module": [
		"./src/app/cad-cliente/cad-cliente.module.ts",
		"cad-cliente-cad-cliente-module"
	],
	"./cad-diarista/cad-diarista.module": [
	...
	"./list-cliente/list-cliente.module": [
		"./src/app/list-cliente/list-cliente.module.ts",
		"list-cliente-list-cliente-module"
	],
	"./list-diarista/list-diarista.module": [
	...
	"./teste-midia/teste-midia.module": [
...
var routes = [
    ...
    { path: 'teste-midia', loadChildren: './teste-midia/teste-midia.module#TesteMidiaPageModule' }
];
...
/* harmony import */ var _diarista_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./diarista.service */ "./src/app/diarista.service.ts");
...
/* harmony import */ var _viacep_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./viacep.service */ "./src/app/viacep.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _diarista_service__WEBPACK_IMPORTED_MODULE_10__["DiaristaService"], _angular_http__WEBPACK_IMPORTED_MODULE_9__["HttpModule"], _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_15__["Camera"],
                ...
                _ionic_native_file_path_ngx__WEBPACK_IMPORTED_MODULE_13__["FilePath"], _viacep_service__WEBPACK_IMPORTED_MODULE_14__["ViacepService"],
...
/***/ "./src/app/diarista.service.ts":
/*!*************************************!*\
  !*** ./src/app/diarista.service.ts ***!
  \*************************************/
/*! exports provided: DiaristaService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DiaristaService", function() { return DiaristaService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var DiaristaService = /** @class */ (function () {
    function DiaristaService(http) {
        this.http = http;
        this.caminho = "http://marceloflorentino.000webhostapp.com/diarista/index.php/";
        this.diarista = "fornecedor/getFornecedor";
        this.cliente = "cliente/getCliente";
        this.diaristas = "fornecedor/setFornecedor";
        this.clientes = "cliente/setCliente";
    }
    DiaristaService.prototype.getCliente = function () {
    ...
    DiaristaService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"]])
    ], DiaristaService);
    return DiaristaService;
}());
...
var ViacepService = /** @class */ (function () {
    ...
    ViacepService.prototype.pegaCep = function (cep) {
        console.log("Valor do cep Recebido" + cep);
        return this.http.get("http://viacep.com.br/ws/" + cep + "/json/");
    };
    ViacepService.ctorParameters = function () { return [
        { type: _angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"] }
    ]; };
...
module.exports = __webpack_require__(/*! D:\producao\apps mobile\marceloApp\diarista-ionic\src\main.ts */"./src/main.ts");
